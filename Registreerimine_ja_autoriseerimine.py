...
while True:
    ...
    print("Если вы хотите сменить имя или пароль нажмите - 3")
    print("Если вы хотите сбросить забытый пароль нажмите - 4")
    ...
    elif выбор == 3:  # Изменить имя или пароль
        изменить_данные(users, passw)
    elif выбор == 4:  # Сбросить пароль
        сбросить_пароль(users, passw)
    elif выбор == 5:  # Выход 
